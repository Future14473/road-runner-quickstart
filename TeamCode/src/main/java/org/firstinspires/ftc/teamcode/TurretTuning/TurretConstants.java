...
public class TurretConstants {
    ...
    static double bevelToTurretTeeth = 30;
    static double turretTeeth = 225;
    static double maxRotationDegrees = 360;

    static double LAZY_SUSAN_TICKS_PER_REVOLUTION = 103.8;

    static double MOTOR_ROTATIONS_PER_TURRET_ROTATIONS = (turretTeeth/bevelToTurretTeeth) * (bevelToTurretTeeth/motorToBevelTeeth)*(motorToBevelTeeth/motorTeeth);
