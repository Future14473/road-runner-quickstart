...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 35 * cmToIn; // in; distance between the left and right wheels
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "taco"));
