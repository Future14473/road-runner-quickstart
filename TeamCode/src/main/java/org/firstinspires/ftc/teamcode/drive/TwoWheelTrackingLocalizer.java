...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 1.00851387413; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.03066255456; // Multiplier in the Y direction
