...
import java.util.List;
    ...
    public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
        ...
        public static double PARALLEL_X = 6.375; // X is the up and down direction
        public static double PARALLEL_Y = -2.0625; // Y is the strafe direction

        public static double PERPENDICULAR_X = -6.75;
        public static double PERPENDICULAR_Y = 1.5625;
